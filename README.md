...
- [x] Show the username and creation time for each post using section headers (+1pt) --showing the creation time
...
- [x] User can like a post and see number of likes for each post in the post details screen (+1pt) --can see the number of likes
...
I added some alert controllers and checks to check the validity of the login so that the user (who can't see the output log) can still understand what went wrong with the login.
...
**please see gif included in the repo, it was too big to fit in the readme!

<img src='https://imgur.com/mtcHvln.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- Pascal pods for the login background gif: https://github.com/cruisediary/Pastel
